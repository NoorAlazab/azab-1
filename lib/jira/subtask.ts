import { refreshJiraTokenIfNeeded } from "@/lib/jira/fetch";
import { formatTestCaseMarkdown } from "@/lib/jira/markdown";
import { requireActiveCloudIdOrThrow, callJiraApi } from "@/lib/jira/base";
import { getJiraConnection } from "@/lib/db/mock";
import type { TestCase, TestPriority } from "@/lib/generator/types";
