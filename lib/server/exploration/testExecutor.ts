...
// Re-export public types so existing `import { TestCase } from '@/lib/server/exploration/testExecutor'`
...
async function navigateToPage(
  ...
  const { loadNavigationData, updateUrlVerification, updateCachedUrl } = await import('@/lib/server/db/selectorService');
